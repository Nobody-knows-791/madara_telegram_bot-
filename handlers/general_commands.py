...
COMMANDS_LIST = [
    ...
    "rank", "warn", "kick", "ban", "afk", "fun", "filter", "couple", "whisper", "fonts", "delete"
]
...
SUMMARIES = {
    ...
    "help_delete": "🗑️ /del - Deletes a replied-to message (admin only) in groups!"
}
...
async def commands_menu(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if data.startswith("commands_start_"):
        ...
        if cmd == "fun":
            ...
            # Handle all other commands (info, photo, stat, etc.)
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not query or query.data in ["help_back", "help_start"]:
        keyboard = [
            ...
            [InlineKeyboardButton("🗑️ ᴅᴇʟ", callback_data="help_delete"),
